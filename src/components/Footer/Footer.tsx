...
//   return (
//     <footer className="border-t border-neutral-200 bg-stone-50 py-16">
...
//             <h2
//               className={`${fontClass} text-3xl font-bold text-[#C08A5B]`}
//             >
//               K.B.N
//             </h2>

//             <p
//               className={`${fontClass} mt-5 leading-8 text-neutral-600`}
//             >
...
//             <h3
//               className={`${fontClass} mb-5 text-xl font-semibold`}
//             >
//               {t.footer.quickLinks}
//             </h3>
...
//               <li>{t.footer.links.collections}</li>
...
//             <div
//               className={`${fontClass} space-y-3 text-neutral-600`}
//             >
